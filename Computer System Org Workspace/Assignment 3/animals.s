...
// 	printf("I'm guessing: %s\n", p->question_or_animal);
	...
	leaq	str7(%rip), %rdi	# first parameter is the format string
...
// 	printf("Am I right? > ");
	...
	leaq	str8(%rip), %rdi	# first parameter is the format string
	xorq	%rax, %rax		# printf requires that %rax is zero
	call	_printf
...
// 	  printf("I win!\n");
	...
	leaq	str9(%rip), %rdi	# first parameter is the format string
	xorq	%rax, %rax		# printf requires that %rax is zero
	call	_printf
...
// 	  printf("\noops.  What animal were you thinking of? > ");
	...
	leaq	str10(%rip), %rdi	# first parameter is the format string
	xorq	%rax, %rax		# printf requires that %rax is zero
	call	_printf
...
// 		 new_question_or_animal, p->question_or_animal);
	...
	leaq	str11(%rip), %rdi	# first parameter is the format string
	leaq	-216(%rbp), %rsi
	leaq	(%rbx), %rdx
	xorq	%rax, %rax		# printf requires that %rax is zero
	call	_printf
...
// 		 new_n->question_or_animal);
	...
	leaq	str12(%rip), %rdi	# first parameter is the format string
...
ELSE2:
	...
	leaq	str13(%rip), %rdi	# first parameter is the format string
	leaq	(%rbx), %rsi
	xorq	%rax, %rax		# printf requires that %rax is zero
	call	_printf
